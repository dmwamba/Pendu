$(document).ready(function() {
    ...
    function redirecTo() {
        document.location.href = "http://wkid.be";
    }

    var words = [
        "autocthone", "degager", "belictueux", "guibolle", "instagram", "plaidante",
        "romance", "actualite", "chronometrage", "insoumission", "magistraux", "mentholer",
        "qualitatif", "certitude", "victoire", "potable", "barrer", "burlescque", "chaume", "cintrage",
        "caracteriser", "incroyable", "beguine", "callgirl", "constricteur", "mausolee", "utilitaire", "wapiti", "xylophone",
        "biscotter", "degradateur", "enfouir", "chatouiller", "vicere", "abricot", "chapeau", "empaillements", "monteur", "protuberante",
        "calligramme", "hebergeuse", "inegalite", "parodier", "vainqueur", "émotionnelle", "photometriques", "pontificat",
        "profitable", "sauterie", "antireflet", "fixer", "indispensable", "luthier", "rigoureuse", "satiable", "traitrise", "firefox",
        "passetemps", "plastic", "poussin", "gonfler", "bionique", "bizarrerie", "famine", "tentant", "justicier", "machinalement", "etagere",
        "embarras", "emboitable", "solliciter", "extracellulaire", "invasion", "reconsolider", "ebrousser", "boulon", "indisposer", "indument",
        "interafricain", "mercurochrome", "preparatif", "apiculture", "aqueduc", "broque", "insatisfaisante", "journalisation", "internet", "synonyme",
        "aiguillonner", "consistante", "cuisiniere", "photographie", "reconforter", "egayer", "arboriste", "corbeille", "injuste", "google",
        "abasourdi", "acerbe", "appetit", "caracteriser", "trainer", "capote", "correspondant", "colocation", "denoyer", "pommier", "pantoufle", "maison",
    ],
